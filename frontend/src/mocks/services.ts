 ...
 * 2-D：StudentService 已切真实后端；3-D：ContentService 已切真实后端；4-D：ConversationService 已切真实后端；4-E：MemoryService 已切真实后端；5-C：QuizService 已切真实后端；teacher-role 保持 Mock。
 */
